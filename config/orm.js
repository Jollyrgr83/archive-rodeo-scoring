...
const orm = {
  ...
  selectAllFromOneTable: (table_name, cb) => {
    var queryString = table_name === "years" ? queryString = `SELECT * FROM years WHERE type = "year";` : queryString = `SELECT * FROM ${table_name};`;
    connection.query(queryString, (err, result) => err ? console.log(err) : cb(result));
  },
